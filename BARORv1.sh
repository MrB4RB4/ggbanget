...
yellow='\033[33;1m'
sleep 1
toilet -f slant -F gay "T00Ls-MR.EROR" | lolcat
echo "\033[35;1m"
cal
date
echo ""      
echo "\033[32;1mAuthor : Mr.EROR & Mr.B4RB4" 
...
echo "0.> keluar"
echo "[===============================================]>"
read -p "root@T00Ls-Er0rv4]~#" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "Mr.Eror" | lolcat
cd module
php tp.php
fi
...
then
clear
toilet -f standard -F gay "Mr.Er0r" 
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "Mr.Er0r" | lolcat
figlet -f slant Mr.Er0r
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "Mr.Er0r" | lolcat
figlet "Mr.Er0r" | lolcat
sleep 1
cd
cd module
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "Mr.Er0r" 
figlet "Mr.Er0r" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
toilet -f standard -F gay "Mr.B4RB4"
